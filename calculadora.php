...
<head>
    ...
    <title>PrestaCRM — Calculadora</title>
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a class="nav-item" href="admin_view.html">
        ...
        <a class="nav-item" href="admin_view2.html">
        ...
        <a class="nav-item" href="admin_view3.html">
    ...
    <div class="sidebar-footer">
        ...
        <div class="user-info">
            <div class="user-name">Admin General</div>
