...
$routes = [
    ...
    ['GET',  '/prestamos/nuevo',       ['auth','role:admin,promo'], 'LoanController',        'newLoan'],
    ['GET',  '/prestamos/detalle',     ['auth','role:admin,promo'], 'LoanController',        'detail'],
    ['POST', '/prestamos/crear',       ['auth','role:admin,promo'],       'LoanController',        'createLoan'],
    ...
    ['GET',  '/empleados/detalle',     ['auth','role:admin'],       'EmployeeController',    'detail'],
    ...
    ['GET',  '/clientes/detalle',      ['auth','role:admin,promo,collector'], 'ClientController',      'detail'],
    ...
    ['POST', '/prestamos/crear2',      ['auth','role:admin,promo'], 'LoanController',        'createLoan2'],
    ['POST', '/prestamos/toggle-interes', ['auth','role:admin'],    'LoanController',        'toggleInterest'],
    ['POST', '/prestamos/toggle-mora',   ['auth','role:admin'],    'LoanController',        'toggleMoraInterest'],
